...
import { addFilms } from './redux/actions/index'
...
export class FilmList extends Component<{}> {
  ...
  async componentDidMount() {
      ...
      try {
          ...
          this.props.dispatch(addFilms(responseJson.results));
      }   catch (error) {
              console.error(error);
          }
  ...
  render() {
    ...
    console.log(this.props.dataSource.length > 0 ? "yes" : "no");
